...
projections = {@Anisotropicl111, @Isotropicl2, @ProjL1Derivative};

noise = [0.025 0.05];
noiseName = {'ResultsHighFinal/', 'ResultsLowFinal/'};
noiseAlpha = {(0.01:0.005:0.08), (0.03:0.005:0.2)};
...
filename1 = [noiseName{b} 'dataPSNR2.dat'];
filename2 = [noiseName{b} 'dataSSIMVAL2.dat'];
filename3 = [noiseName{b} 'dataSAMAVE2.dat'];
filename4 = [noiseName{b} 'dataSAMVAR2.dat'];
